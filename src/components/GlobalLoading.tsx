...
import { useLoading } from '@/store/loading.tsx';
...
export const GlobalLoading: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[99] flex items-center justify-center bg-black/20 transition-all">
      <div className="flex flex-col items-center gap-3 rounded-xl bg-black/50 px-8 py-6 shadow-2xl backdrop-blur-md">
        {/* Spinner */}
