import { Star, ExternalLink, PackageSearch } from "lucide-react";
...
const GoldenThreeSection = ({ products, isSearchResult = false }: GoldenThreeSectionProps) => {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-pink-500 mb-4 flex items-center justify-center gap-2">
            ...
            {isSearchResult ? 'Search Results' : 'Golden Three'}
            <span className="text-pink-400">✨</span>
          </h2>
          {
            !isSearchResult && (
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-12 text-center border-2 border-dashed border-gray-300">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <button
                  ...
                  className="px-6 py-3 border border-gray-300 hover:border-pink-500 text-gray-700 hover:text-pink-600 rounded-lg font-medium transition-colors"
                >
